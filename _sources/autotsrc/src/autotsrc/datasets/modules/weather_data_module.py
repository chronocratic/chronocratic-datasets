...
class WeatherDataModule(BaseForecastingTimeSeriesDataModule):
    ...
    def _transform_data(self) -> None:
        """Convert to batch-first forecasting tensor layout."""
        if not isinstance(self._full_data, np.ndarray):
            self._full_data = np.array(self._full_data)
    ...
    def prepare_data(self) -> None:
        """Load and prepare Weather data and derive train/validation/test slices."""
    ...
    def train_dataloader(
        ...
        *,
        ...
        """Build the training dataloader for the prepared Weather split."""
    ...
    def val_dataloader(
        ...
        *,
        ...
        """Build the validation dataloader for the prepared Weather split."""
    ...
    def test_dataloader(
        ...
        *,
        ...
        """Build the test dataloader for the prepared Weather split."""
