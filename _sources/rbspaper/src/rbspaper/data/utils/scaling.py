...
from src.rbspaper.data.utils.common import flatten_list_of_np_arrays

__all__ = ['DataFormEnum', 'create_data_scaler']
...
def create_data_scaler(
    *,
    ...
    Args:
        ...
        scaling_method: Either 'min_max' or 'standardization'.
...
def _get_scaler(
    ...
    Args:
        scaling_method: 'min_max' or 'standardization'.
