...
class TestModeMapping:
    ...
    def test_classification_loader_map_sample_only(self):
        from tscollection.datasets.enums import ClassificationLoaderMode, TimeSeriesDatasetMode
    ...
    def test_forecasting_loader_map_input_target(self):
        from tscollection.datasets.enums import ForecastingLoaderMode, TimeSeriesDatasetMode
        from tscollection.datasets.maps.loader_to_dataset import FORECASTING_LOADER_MAP
